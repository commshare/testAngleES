...
// compile the shader.
//
GLuint TESTLoadShader(GLenum type, const GLchar *shaderSrc)
{
    GLuint shader;
    GLint compiled;
...
int Init()
{
    ...
    vertexShader = TESTLoadShader(GL_VERTEX_SHADER, vertexShaderString);
    fragmentShader = TESTLoadShader(GL_FRAGMENT_SHADER, fragmentShaderString);
